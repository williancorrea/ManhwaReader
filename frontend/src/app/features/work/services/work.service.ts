...
import { ChapterItem, ChapterReaderData, NextUnreadInfo, WorkDetail } from '../models/work.models';
...
export class WorkService {
  ...
  getNextUnread(slug: string): Observable<NextUnreadInfo> {
    return this.http.get<NextUnreadInfo>(`${environment.apiUrl}/works/${slug}/next-unread`);
  }
