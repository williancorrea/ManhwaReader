        ...
        <div class="card px-6 py-20 md:px-12 lg:px-20">
            ...
            <div class="mt-4 md:mt-20">
                ...
                <div class="grid grid-cols-12 gap-4">
                    <div *ngFor="let member of teamMembers; let i = index" class="col-span-12 lg:col-span-6 xl:col-span-3 p-4">
                        <div class="relative overflow-hidden" (mouseenter)="setVisibleMember(i)" (mouseleave)="setVisibleMember(-1)">
                            ...
                            >
                                <div class="flex flex-col p-8 h-full">
                                    ...
                                    <div class="mt-auto">
                                        <a *ngFor="let socialIcon of member.socialIcons" tabindex="0" class="cursor-pointer">
                                            <i [ngClass]="socialIcon.iconClass" [class]="socialIcon.additionalClasses + ' ' + 'text-white'"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
