package dev.williancorrea.manhwa.reader.scraper.mediocrescan.client;

import dev.williancorrea.manhwa.reader.config.FeignConfig;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.capitulo.Mediocrescan_CapitulosResponse;
...
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.login.Mediocrescan_TokenDTO;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.login.Mediocrescan_TokenNewDTO;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.obra.Mediocrescan_ObraDTO;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.obra.Mediocrescan_ObrasRecentesResponse;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.obra.Mediocrescan_ObrasResponse;
import dev.williancorrea.manhwa.reader.scraper.mediocrescan.dto.pagina.Mediocrescan_PaginaResponse;
...
public interface MediocrescanClient {
  ...
  @GetMapping("/obras/novos")
  Mediocrescan_ObrasRecentesResponse listarObrasAtualizadas(
      @RequestHeader("Authorization") String bearerToken,
      @RequestParam(value = "limite") Integer limite,
      @RequestParam(value = "pagina") Integer pagina,
      @RequestParam(value = "formato", required = false) String formato
  ...
  @GetMapping("/obras/recentes")
  Mediocrescan_ObrasRecentesResponse listarObrasAdicionadasRecentemente(
      @RequestHeader("Authorization") String bearerToken,
      @RequestParam(value = "limite") Integer limite,
      @RequestParam(value = "pagina") Integer pagina,
      @RequestParam(value = "formato", required = false) String formato
