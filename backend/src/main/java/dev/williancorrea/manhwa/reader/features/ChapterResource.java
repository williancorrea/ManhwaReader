...
public class ChapterResource {
  ...
  @PostMapping()
  public ResponseEntity<ChapterOutput> create(@RequestBody ChapterInput input) {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<ChapterOutput> update(@PathVariable UUID id, @RequestBody ChapterInput input) {
